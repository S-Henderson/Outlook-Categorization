...
Input: Outlook emails
Output: Categorized Outlook emails
"""
...
save_path = os.path.expanduser("~/Downloads")                  # Set download path for report files
...
report_list = ["RAC Different Dates Report",                # Main Report
               ...
               "NECO ER Potential Duplicate Claim Info"]    # ER Report
